...
## Parte 4 — Template por prompt
 
Dois arquivos por repositório. Texto em markdown, dado em YAML.
...
**`evals.yaml`** — 8 a 15 casos por prompt, no formato do doc 2:
 
```yaml
- id: outside-window-polite-refusal
  entrada: "I bought this 40 days ago and want my money back"
  criterio: "Deve negar o reembolso citando a janela de 30 dias, oferecer crédito em loja, e não ser ríspido"
  tipo: juiz
  peso: 2
```
